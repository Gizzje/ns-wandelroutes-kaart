"""
Voegt een "province"-veld toe aan elke route in data/routes.geojson, nodig
voor de provincie-achievements ("eerste route in deze provincie", "elke
provincie een keer gelopen"). Wandelnet zelf geeft dit niet per route mee,
dus dit wordt afgeleid uit de routegeometrie: het beginpunt van elke route
wordt tegen de officiele provinciegrenzen gelegd (point-in-polygon).
